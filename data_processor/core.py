...
# Dictionnaires de latitudes et longitudes pour chaque département de France
...
# Créer le dossier 'data' une fois au début du script
...
# Obtenir les années uniques dans staged_data
unique_years = staged_data['Year'].unique()

# Tạo vòng lặp để xử lý từng năm
for year in unique_years:
    ...
    # Sauvegarder staged_data pour l'année spécifique
    staged_data_year.to_csv(f"../data/staged_data_{year}.csv", index=False, encoding="utf-8")
        
    # Calculer les indicateurs et répartitions spécifiques pour chaque année
    ...
    # Ajouter les colonnes dr région
